  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        bgColorCycle: 'bgColorCycle 2.5s infinite',
      ...
      colorCycle: {
        ...
        bgColorCycle: {
        '0%': { backgroundColor: '#f472b6' }, 
        '5%': { backgroundColor: '#db85c7' }, 
        '16%': { backgroundColor: '#c084fc' },
        '33%': { backgroundColor: '#22d3ee' },
        '50%': { backgroundColor: '#14b8a6' },
        '66%': { backgroundColor: '#19ff4b' }, 
        '83%': { backgroundColor: '#facc15' }, 
        '93%': { backgroundColor: '#a855f7' }, 
        '100%': { backgroundColor: '#f472b6' }, 
      },
      blinkAndBounce: {
