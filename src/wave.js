document.addEventListener('DOMContentLoaded', () => {
  ...
  function playSong(songFile, button) {
    ...
    if (currentPlayingButton) {
      currentPlayingButton.classList.remove('animate-glowGreenShadowCycle', 'animate-flashSlow', 'drop-shadow-lg');
    }
    currentPlayingButton = button;
    button.classList.add('animate-glowGreenShadowCycle', 'drop-shadow-lg');
  ...
  audio.addEventListener('play', () => {
    currentPlayingButton.classList.add('animate-glowGreenShadowCycle', 'drop-shadow-lg');
  ...
  audio.addEventListener('pause', () => {
    ...
    currentPlayingButton.classList.remove('animate-glowGreenShadowCycle', 'drop-shadow-lg');
